...
// 
// 
// bool canReach(const vector<int>& a, int idx, long long val, long long y) {
    // if (val == y) {
        // return true;
    // }
    // if (idx >= a.size()) {
        // return false;
    // }
    // bool alice_result = canReach(a, idx + 1, val + a[idx], y);
    // bool bob_result = canReach(a, idx + 1, val ^ a[idx], y);
...
// 
        ...
        // }
// 
        // // Check if Alice can reach y
        // bool alice_reachable = canReach(a, 0, x, y);
// 
        // // Check if Bob can reach y
        // bool bob_reachable = canReach(a, 0, x + 3, y);
// 
        // // Print the result
        // if (alice_reachable) {
            // cout << "Alice" << endl;
        // } else if (bob_reachable) {
            // cout << "Bob" << endl;
        // }
    // }
// 
...
signed main(){
	...
	while(t--){
		...
		if((x%2==y%2 and sum%2==0)||(x%2!=y%2 and sum%2==1)) 
	cout<<"Alice"<<endl;
	else{
		cout<<"Bob"<<endl;
	}
