...
// URL: https://codeforces.com/contest/279/problem/A
// Memory Limit: 256 MB
// Time Limit: 2000 ms
// 
...
void solve()
{
     ...
     // if(a>0 and b>0){
     	...
     	// // }
     	// // else{
     		// cout<<pp+((a-1)*4)-1<<endl;;
     	// // }
     // }
//      
     // else if(a<=0 and b>0){
     	// cout<<np+((b-1)*4)-1<<endl;
     // }
     // else if(a<0 and b<=0){
     	// cout<<nn+ ((abs(a)-1)*4)-1<<endl;
     // }
     // else{
     	// cout<<pn+((a-1)*4)-1<<endl;
     // }
     
     else if(-a+1<b and b<=a){
     	cout<<1+(a-1)*4<<endl;
     }
     else if(-b<=a and a<b){
     	cout<<2+(b-1)*4<<endl;
