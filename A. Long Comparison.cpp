...
////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
string compareNumbers(int a, int z1, int b, int z2) {
     ...
     else if( adig+z1< bdig+z2){
     	return "<";
     }
     	int diff=abs(adig-bdig);
     if(adig>bdig){
     b*=powi(10,diff);
     }
     else {
...
signed main() {
    ...
    while (testCases--) {
        int firstNumber, firstZeros, secondNumber, secondZeros;
        cin >> firstNumber >> firstZeros >> secondNumber >> secondZeros;

        // Compare the numbers and print the result
        cout << compareNumbers(firstNumber, firstZeros, secondNumber, secondZeros) << endl;
    }
