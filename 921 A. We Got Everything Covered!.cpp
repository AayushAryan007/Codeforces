...
// URL: https://codeforces.com/contest/1925/problem/0
// Memory Limit: 256 MB
// Time Limit: 1000 ms
// 
...
// 
    ...
    // cin >> n >> k;
// 
    // // Construct the first half of the palindrome using the first k characters
    // string firstHalf = h.substr(0, k);
// 
    // // Construct the entire palindrome by concatenating the first half with its reverse
    // string palindrome = firstHalf + string(firstHalf.rbegin(), firstHalf.rend());
// 
    // // Repeat the palindrome n // (2 * k) times to cover the entire string
    // string result = "";
    // for (int i = 0; i < n / (2 * k); i++) {
        // result += palindrome;
    // }
// 
    // // Append the remaining characters if n is not a multiple of (2 * k)
    // result += palindrome.substr(0, n % (2 * k));
// 
    // cout << result << endl;
// }
