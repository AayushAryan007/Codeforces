...
//        
     // }
      // cout<<count<<endl; //count increasing subsequences
//      
//     
     // if(count<=k){
     	// cout<<"Yes"<<endl;
...
// 2
// Yes
// this didnt work because after sorting some extra element might come  between 2 prev sequence with is not changable afterwords in this code, hence second tc gives 3 subarrays instead of 4
