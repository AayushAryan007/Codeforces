...
// URL: https://www.codechef.com/START115C/problems/MAKE0
// Memory Limit: 256 MB
// Time Limit: 1000 ms
// 
...
////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
int minOperations(std::vector<int>& arr, int N) {
...
int top=0;
    ...
    while (!pq.empty()) {
     top = pq.top();
        ...
        if (top <= totalOps) {
            return top+totalOps; // Cannot perform the operation without negative values
        }
