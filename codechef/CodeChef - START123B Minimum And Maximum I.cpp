// Problem: Minimum And Maximum I
// Contest: CodeChef - START123B
// URL: https://www.codechef.com/START123B/problems/MINANDMAX
// Memory Limit: 256 MB
// Time Limit: 1000 ms
// 
...
// 
    // while (t--) {
        ...
        // cin >> n;
// 
        // // Create an initial permutation [1, 2, 3, ..., N]
        // vector<long long> initialPermutation(n);
        // for (int i = 0; i < n; ++i) {
            // initialPermutation[i] = i + 1;
        // }
// 
        // // Create the modified permutation [1, N, 2, N-1, 3, ...]
        // vector<long long> modifiedPermutation(n);
        // for (int i = 0; i < n; ++i) {
            // if (i % 2 == 0) {
                // modifiedPermutation[i] = initialPermutation[i / 2];
            // } else {
                // modifiedPermutation[i] = initialPermutation[n - 1 - i / 2];
            // }
        // }
// 
        ...
        // long long result = 0;
        // for (int i = 1; i <= n; ++i) {
            // result += min(modifiedPermutation[i % n], modifiedPermutation[(i % n + 1) % n]);
        // }
// 
        // // Output the result
        // cout << result << endl;
