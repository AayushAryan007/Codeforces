// Problem: Make It One
// Contest: CodeChef - START124B
// URL: https://www.codechef.com/START124B/problems/MAKE_IT_ONE
// Memory Limit: 256 MB
// Time Limit: 1000 ms
// 
...
int main() {
    ...
    while (T--) {
    	...
    	cin>>l>>r;
    	 ...
    	 if(n%2==0){
    	 	...
    	 	ans[r-l]=r;
    	 	for(ll i=l;i<r;i++){
    	 		if(__gcd(r,ans[i-l])==1 and gcd(r,i)==1){
    	 			swap(ans[i-l],ans[r-l]);
    	 			break;
    	 		}
    	 	}
    	 }
    ...
    // int L, R;
        ...
        // }
        // b=array;
        // rightRotateArray(array,1);
//      
// 
        // bool valid = true;
        // for (int i = 0; i < R - L+1; ++i) {
            // if (__gcd(array[i], b[i ]) != 1) {
                // valid = false;
                // break;
            // }
        // }
