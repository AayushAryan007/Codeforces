...
////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
// std::vector<int> generatePermutation(int N, int X) {
    // if (X >= N || X < 0) {
        // // Invalid X value, return an empty vector to signify no valid permutation exists
        // return {};
    // }
// 
    // std::vector<int> permutation(N);
// 
    // // Fill the permutation array with values from 1 to N
    // for (int i = 0; i < N; ++i) {
        // permutation[i] = i + 1;
    // }
// 
    // // Swap elements to create the required difference between LIS and alicelis function
    // for (int i = 0; i < X; ++i) {
        // std::swap(permutation[i], permutation[N - i - 1]);
    // }
// 
    // return permutation;
// }
