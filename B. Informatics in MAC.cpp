...
////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
// increase partition and check in whic
// h case the mex of both parts are similar using set
// void solve()
// {
    // int n;
    // cin>>n;
...
void solve(){
	...
	for(int i=0;i<n;i++){
		preV.insert(v[i]);
		while(preV.count(a)) a++;
		preMEX[i]=a;
	}
	
	for(int i=n-1;i>=0;i--){
		sufV.insert(v[i]);
		while(sufV.count(b)) b++;
