...
////////////////////////////////////////////////////////////////////////////////////
///////////////////////////////////////////////////////////////////////////////////
//well ofc the brute force gives tle
// void solve()
// {
    // int n;
    // cin>>n;
...
// void solve() {
    ...
    // vll v(n);
    // ll count = 0;
    // for (ll i = 0; i < n; i++) {  // Adjusted loop range from 0 to n-1
        // cin >> v[i];
        // if (v[i] == i + 1)  // Since indexing starts from 0, the number to compare should be i+1
            // count++;
    // }
    // cout << count * (count - 1LL) / 2 << endl;
// }
