...
void solve()
{
     string input;
     cin>>input;
     char letter = input[0]; // Extracting the first character as a char
    int number = stoi(input.substr(1)); // Extracting the substring from index 1 to the end and converting to int
