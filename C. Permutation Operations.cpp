...
//   
    ...
    // for (int i = 1; i <= n; i++) {
        // if (j < vp.size()) {
            // int temp = c[vp[j].second-1];
// 
            // while (vp[j].first > vp[j].second) {
                // vp[j].second += i;
                // cout << temp << " ";
                // count++;
                // i++;
...
//         
    // }
       // for(int i=0;i<n-count;i++) cout<<1<<" ";
    // cout<<endl;
}
