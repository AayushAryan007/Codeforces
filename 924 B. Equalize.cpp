...
//     	
        // int r= l[i] -1+k;
//         
        // auto it = upper_bound(l, l + idx, r);
//         
//         
        // int count = distance(l, it) - i;
        // ans = max(ans, count);
    // }
// 
    // cout << ans << endl;
...
// // 
    ...
    // // }
// // 
    // // vector<ll> uniqueVector(uniqueSet.begin(), uniqueSet.end());
// // 
    // // ll k = n;
// // 
    // // for (ll i = 0; i < uniqueVector.size(); i++) {
        // // ll en = uniqueVector[i] - 1 + k;
// // 
        // // auto it = upper_bound(uniqueVector.begin(), uniqueVector.end(), en);
// // 
        // // ll count = distance(uniqueVector.begin(), it) - distance(uniqueVector.begin(), find(uniqueVector.begin(), uniqueVector.end(), uniqueVector[i]));
        // // ans = max(ans, count);
    // // }
// // 
    // // cout << ans << endl;
