...
return dp[i][j] = min(rec(dp, v, i + 1, j), rec(dp, v, i, j - 1)) + (v[j] - v[i]);
...
// //     
    ...
    // // sort(all(b));
     // // for (auto i:a) {
        // // // Calculate the discrepancy for the i-th member
       // // cout<<i<<" ";
       // // }cout<<endl;
      // // for (auto i:b) {
        // // // Calculate the discrepancy for the i-th member
...
// }
   // int sum=0;
   // int mini=speed[0], maxi=speed[0];
    // for (int i=1;i<n;i++) {
        // // Calculate the discrepancy for the i-th member
      // mini=min(speed[i],mini);
      // maxi=max(speed[i],maxi);
      // sum+=maxi-mini;  
    // }
//     
//     
