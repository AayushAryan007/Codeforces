...
void solve(){
	...
	count+=hash[2]/2;
	if(hash[2]%2==0) hash[2]=0;
	else hash[2]=1;
	
	hash[1]+=hash[2]*2;
	if(hash[1]%4==0)
	count+=hash[1]/4;
	else count+=hash[1]/4+1;
...
// 	
	// // debug(hash)
	// // if(hash[3]>0 and hash[1]>0){
		// // count+=min(hash[3],hash[1]);
		// // int c=min(hash[3],hash[1]);
		// // hash[3]-=c;
		// // hash[1]-=c;
// // 		
// // 		
...
// 	
	// count+=hash[2]/2;
	// if(hash[2]%2==1) hash[2]=1;
	// else hash[2]=0;
// 	
	// // debug(hash)
	// // if(hash[2]==1 and hash[1]>=3){
		// // count+=0;
		// // hash[2]=0;
		// // hash[1]-=3;
	// // }
