...
//         
    ...
    // }
//     
    // vector<int> evpref,odpref;
//     
    // evpref.pb(ev[0]);
    // odpref.pb(od[0]);
//     
    // int last=max(ev.size(),od.size());
    // for(int i=1; i<last;i++){
//         
        // evpref.push_back(evpref[i-1]+ev[i]);
        // odpref.push_back(odpref[i-1]+od[i]);
//         
    // }
    // if(n%2==1)
    // odpref.pop_back();
...
//     
    ...
    // for(int i=size;i>0;i--){
    	// for(int j=i-1;j>=0;j--){
    		// if(odpref[i]-odpref[j]==evpref[i]-evpref[j]){
    			// check=1;
    			// break;
    		// }
    	 // if(flag and odpref[i]-odpref[j]==evpref[i+1]-evpref[j+1]){
    			// check=1;
    			// break;
    		// }
//     		
...
//     
    // // for(int i=last;i>=0;i--){
        // // for(int j=i-1;j>=0;j--){
            // // if(evpref[i]-evpref[j] == odpref[i]-odpref[j]){
                // // cout<<"YES"<<endl;
                // // return;
            // // }
// //             
            // // // if(evpref[i]==odpref[i]-odpref[j] || odpref[i]==evpref[i]-evpref[j]){
            // // //     cout<<"YES"<<endl;
            // // //     return;
            // // // }
        // // }
